...
const About = () => {
    return (
        ...
        <details className="mission">
                <summary><h1>Our Mission & Purpose</h1></summary>
            ...
            <h1>Our company and founder</h1>
            <p>Aquilis was founded by Nicholas Aquilante III in 2007, the first shop located in Glassport, Pennsylvania. What started as a home based business, simply completing the computer repairs in customers homes, expanding to operating two different shops, meeting the business needs of individuals and corporations both, while always keeping the option to work from a customer's home.</p>
            <br/>
            <p>Nicholas always had an affinity for working on and fixing computers, taking his first computer apart at the age of 12 and fixing his first one, his mother's at the age of 13, and knew he found his niche.</p>
